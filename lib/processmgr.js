...
(function() {
  ...
  ProcessManager = (function(superClass) {
    ...
    ProcessManager.prototype.waitpid = function(pid, opts, callback) {
      var counter, interval, ref, ref1, test, timeout;
      if (!((pid != null) && (opts != null) && (opts.test != null))) {
        response(new Error("must pass in proper options for waitpid!"));
      }
      test = opts.test;
      timeout = (ref = opts.timeout) != null ? ref : 0;
      interval = (ref1 = opts.interval) != null ? ref1 : 100;
      counter = 0;
      return async.until(function() {
        ...
        if (timeout !== -1) {
          if ((counter * interval) > timeout) {
            return wait("timeout reached while waiting on PID");
          }
        }
        counter++;
