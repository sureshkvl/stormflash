...
(function() {
  ...
  _install_npm = function(data, callback) {
    ...
    return exec("npm install " + data.name + "@" + data.version + "; ls -l ./node_modules/" + data.name + " ", function(error, stdout, stderr) {
    ...
    StormPackageManager.prototype.install = function(pkg, callback) {
      ...
      switch (parsedurl.protocol) {
        case 'npm:':
          ...
          _install_npm(pkg, function(result) {
            console.log(result);
    ...
    StormPackageManager.prototype.list = function(callback) {
      ...
      try {
        if (this.packageApp === 'dpkg') {
          ...
          return rundpkg(function(resultarray) {
