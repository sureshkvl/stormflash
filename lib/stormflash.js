...
(function() {
  var StormAgent, StormFlash, instance,
  ...
  StormFlash = (function(_super) {
    ...
    function StormFlash(app) {
      var packagelist, processlib;
      this.app = app;
      ...
      this.db = require('dirty')('/tmp/stormflash.db');
      ...
      StormFlash.__super__.constructor.apply(this, arguments);
    }
    ...
    StormFlash.prototype.execute = function(command, callback) {
      if (!command) {
    ...
    StormFlash.prototype.add = function(module, entry, type, callback) {
    ...
    StormFlash.prototype.activate = function(stormdata, callback) {
      return async.until(function() {
        ...
        async.waterfall([
          function(next) {
            ...
            return this.register(stormdata, function(agentId) {
              if (agentId) {
                return next(null, agentId);
              } else {
                return next(new Error("unable to register against stormtracker at " + stormdata.stormtracker + "!"));
              }
            });
          }, function(agentId, next) {
            return this.generateCSR(agentId, function(csr) {
              if (csr) {
                return next(null, csr);
              } else {
                return next(new Error("unable to generate CSR!"));
              }
            });
          }, function(csr, next) {
            return this.sendCSRRequest(csr, function(result) {
              if (result) {
                return next(null);
              }
            });
