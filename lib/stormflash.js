...
(function() {
  ...
  StormFlash = (function(_super) {
    var exec, fs, path, spm, uuid, validate;
    ...
    StormFlash.prototype.run = function(config) {
      ...
      return this.packages.on('ready', (function(_this) {
        return function() {
    ...
    StormFlash.prototype.addServices = function(service) {
      return this.services.add(service.id, {
    ...
    StormFlash.prototype.removeServices = function(service) {
      return this.services.remove(service.id);
    };
