    ...
    StormFlash.prototype.invoke = function(service, callback) {
      ...
      return this.processmgr.waitpid(pid, {
        ...
        return function(err, duration) {
          ...
          _this.log("" + service.id + " has successfully started, took " + duration + " seconds");
          ...
          service.on('changed', function() {
            ...
            return _this.processmgr.waitpid(service.id, {
              test: false,
              timeout: 5000
            }, function(err, duration) {
              if (err != null) {
                return _this.log("" + service.id + " failed to stop in " + duration + " ms... keeping things as-is");
              }
              _this.log("" + service.id + " has successfully stopped, took " + duration + " ms");
              opts = service.invocation;
