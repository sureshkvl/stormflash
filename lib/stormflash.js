...
(function() {
  ...
  StormFlash = (function(_super) {
    ...
    function StormFlash(config) {
      var extend, os, pkgconfig, processlib, _ref;
      ...
      if (pkgconfig != null) {
        ...
        if (pkgconfig.functions != null) {
          (_ref = this.functions).push.apply(_ref, pkgconfig.functions);
        }
      }
      this.log("StormFlash - initialized with:\n" + this.inspect(this.functions));
      os = this.env.os();
      this.on('ready', (function(_this) {
        return function(zappa) {
          _this.log("loading API endpoints");
        ...
        return function(pkg) {
          ...
          if (pkg instanceof StormPackage) {
            ...
            if (pkg.functions != null) {
              return (_ref1 = _this.functions).push.apply(_ref1, pkg.functions);
            }
          }
        };
      })(this));
