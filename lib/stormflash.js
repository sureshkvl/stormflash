        ...
        return function(err, duration) {
          ...
          service.on('changed', function() {
            ...
            return _this.processmgr.waitpid(service.instance, {
              ...
              if (opts.monitor) {
                service.isRestarting = false;
                _this.log("Service changed, process " + service.instance + " is stopped. Monitor to restart the process " + opts.name);
                return;
              }
          ...
          if (opts.monitor) {
            return async.whilst(function() {
              ...
              return (function(waitPid) {
                this.log("monitor: starting to watch for " + service.id + " running on PID " + service.instance + "...");
                return this.processmgr.waitpid(waitPid, {
                  test: false,
                  timeout: -1,
                  interval: 1000
                }, (function(_this) {
