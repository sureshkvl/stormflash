    ...
    StormFlash.prototype.invoke = function(service, callback) {
      ...
      return this.processmgr.waitpid(pid, {
        ...
        return function(err, duration) {
          ...
          callback(null, pid);
          if (opts.monitor) {
            _this.log("monitor: starting to watch for " + service.id + "...");
            return async.whilst(function() {
              ...
              return _this.processmgr.waitpid(service.instance, {
                ...
                _this.log("monitor: " + service.id + " stopped running after " + (duration / 1000) + " seconds!");
                if (service.isStarting) {
                  _this.log("monitor: ignoring since the process is in the process of starting, going back to monitoring...");
