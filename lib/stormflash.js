...
(function() {
  ...
  StormPackages = (function(_super) {
    ...
    StormPackages.prototype.match = function(pinfo) {
      ...
      if (packages[0] != null) {
        this.log("Matched Package ", packages[0]);
      }
      return packages[0];
    };
    ...
    StormPackages.prototype.find = function(name, version) {
      ...
      if (packages[0] != null) {
        this.log("Found Package ", packages[0]);
      }
      return packages[0];
    };
  ...
  StormFlash = (function(_super) {
    ...
    StormFlash.prototype.start = function(key, callback) {
      ...
      pid = this.processmgr.start(entry.data.name, entry.data.path, entry.data.args, entry.data.stdio, entry.data.options, key);
      if (pid == null) {
