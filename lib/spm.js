        ...
        for (entry in modules.dependencies) {
          ...
          if (typeof modules.dependencies[entry].dependencies === 'object') {
            ...
            _results.push((function() {
              var _base1, _ref1, _results1;
              _results1 = [];
              for (content in curobject) {
                result = {
                  name: content,
                  version: (_ref1 = (_base1 = curobject[content]).version) != null ? _ref1 : _base1.version = "*",
                  source: 'dependency'
                };
                _results1.push(this.emit("discovered", "npm", result));
              }
              return _results1;
            }).call(_this));
          } else {
    ...
    StormPackageManager.prototype.monitor = function(repeatInterval) {
      ...
      this.on("monitor", function() {
        ...
        if (repeatInterval == null) {
          repeatInterval = _this.repeatInterval;
        }
