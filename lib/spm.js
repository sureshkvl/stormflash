(function() {
  ...
  StormPackageManager = (function(_super) {
    ...
    function StormPackageManager(repeatInterval) {
      var _this = this;
      ...
      if (!(this.repeatInterval != null)) this.repeatInterval = 5000;
    }

    StormPackageManager.prototype.monitorDebPkgs = function() {
      var _this = this;
      console.log("searching for debian packages");
      return exec("dpkg -l | tail -n+6", function(error, stdout, stderr) {
        var content, contents, pkg, result, _i, _len, _results;
        if (stdout != null) {
          ...
          for (_i = 0, _len = contents.length; _i < _len; _i++) {
            ...
            if ((content[1] != null) && (content[2] != null)) {
              ...
              _results.push(_this.emit('discovered', "deb", result));
            } else {
    ...
    StormPackageManager.prototype.monitorNpmModules = function() {
      var _this = this;
      console.log("Searching for NPM modules");
      return exec("npm ls --json", function(error, stdout, stderr) {
        ...
        for (entry in modules.dependencies) {
          ...
          _this.emit("discovered", "npm", result);
          if (typeof modules.dependencies[entry].dependencies === 'object') {
            ...
            _results.push((function() {
              ...
              for (content in curobject) {
                ...
                _results2.push(this.emit("discovered", "npm", result));
              }
              return _results2;
            }).call(_this));
          } else {
    ...
    StormPackageManager.prototype.monitor = function(repeatInterval) {
      var emitter,
        _this = this;
      emitter = function() {
        return _this.emit("monitor");
      };
      this.on("monitor", function() {
        _this.monitorDebPkgs();
        _this.monitorNpmModules();
        if (repeatInterval == null) repeatInterval = _this.repeatInterval;
        return setTimeout(emitter, repeatInterval);
      });
      return emitter();
      /*
              async.whilst(
