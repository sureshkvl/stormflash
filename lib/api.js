  ...
  this.include = function() {
    ...
    this.post({
      '/packages': function() {
        ...
        console.log(result);
        return this.storm.install(this.body, (function(_this) {
          return function(res) {
            console.log(res);
    ...
    this.get({
      '/packages': function() {
        return this.storm.list((function(_this) {
          return function(res) {
            console.log(res);
            return _this.send(res);
          };
    ...
    validateModuleDesc = function() {
      ...
      result = this.storm.validate(this.body);
      console.log(result);
      if (!result.valid) {
    ...
    loadModule = function() {
      var result;
      result = this.storm.lookup(this.params.id);
    ...
    this.post('/plugins', validateModuleDesc, function() {
      var module;
      module = this.storm["new"](this.body);
      return this.storm.add(module, '', true, (function(_this) {
        return function(res) {
    ...
    this.put('/plugins/:id', validateModuleDesc, loadModule, function() {
      var module;
      module = this.storm["new"](this.body, this.params.id);
      return this.storm.update(module, this.request.module, (function(_this) {
        return function(res) {
          if (!(res instanceof Error)) {
            if (res.status === 304) {
              return _this.send(304);
    ...
    this.del('/plugins/:id', loadModule, function() {
      return this.storm.remove(this.request.module, (function(_this) {
        return function(res) {
          if (!(res instanceof Error)) {
            if (res.result === 304) {
              return _this.send(304);
